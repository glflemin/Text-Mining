# -*- coding: utf-8 -*-
"""
Created on Sat Oct 20 19:54:05 2018
...
df = pd.read_csv('france_wine.csv') # what's up with the r's?
doc = []
...
# testing; works! 
spain_mask = plt.imread("C:\\Users\\Grant\\Downloads\\franceflag.png")
spain_mask
spain_mask.shape
type(spain_mask)
...
spain_mask = np.array(Image.open("C:\\Users\\Grant\\Downloads\\franceflag.png"))
spain_mask.shape
...
spain2_mask = np.array(Image.open("C:\\Users\\Grant\\Downloads\\france.png")) # transparent version is bad. Gotta change
spain2_mask.shape
spain2_mask
...
# WORKS!
spain_text = str(empty)
spain2_wordcloud = WordCloud(background_color="white", max_words=500, mask=spain2_mask, contour_width=2, contour_color='firebrick') # makes the object
spain2_wordcloud.generate(spain_text)
spain2_wordcloud.to_file("hateverything.png")
plt.figure(figsize=[30, 30])
plt.axis("off")
plt.imshow(spain2_wordcloud, interpolation="bilinear") # "loads" into plot fx so can display # still not sure what this does
plt.show()
